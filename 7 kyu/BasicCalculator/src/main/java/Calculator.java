...
public class Calculator {
    public static Double calculate(final double numberOne, final String operation, final double numberTwo) {
        ...
        try{
            return operation.equals("+")? numberOne+numberTwo: operation.equals("-")? numberOne-numberTwo:
                    operation.equals("*")? numberOne*numberTwo: ((operation.equals("/") && Double.isInfinite(numberOne/numberTwo)))? null :
